...
You are not allowed to search for security vulnerabilities on any hosted service of Godocit without the consent of the party hosting it.
Godocit is open source software and can be installed for testing and security issues on your own infrastructure.
